...
if f_tupla_isNumber(v_data) and f_tupla_isNumber(v_weigt) :
    ...
    v_Mediana = m_smallstatistic.f_Median(v_data)
    v_variance = m_smallstatistic.f_Variance(v_data)
    v_desEstandar = m_smallstatistic.f_standard_Deviation(v_data)
    v_Weighted_Mean = m_smallstatistic.f_Weighted_Mean(v_data, v_weigt)
